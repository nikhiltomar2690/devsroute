...
export const TermsandConditions = () => {
  return (
    <div>
      ...
      <div className="terms">
        <p>
          These terms and conditions applies to the DevsUnite app (hereby
          referred to as &quot;Application&quot;) for mobile devices that was
          created by DevsUnite (hereby referred to as &quot;Service
        ...
        <p>
          Also read our{" "}
          <NavLink to="/privacypolicy" className="privacypolicytext">
            Privacy Policy
          </NavLink>{" "}
          here
        </p>
